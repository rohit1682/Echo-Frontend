...
import { AssetsPanel } from '../../features/finance/AssetsPanel';
import { LoansPanel } from '../../features/finance/LoansPanel';
import { SpendingPanel } from '../../features/finance/SpendingPanel';
  ...
  return (
    <Screen scroll={false} padded={false}>
      ...
      <Animated.View key={segment} entering={FadeIn.duration(220)} style={{ flex: 1 }}>
        ...
        {segment === 'assets' && <AssetsPanel />}
        {segment === 'loans' && <LoansPanel />}
        {segment === 'spending' && <SpendingPanel />}
        {COMING_SOON[segment] && (
